...
public class CameraStage3Script : MonoBehaviour {
	...
	void Update () {
		...
		if (mode == 0) {
			MyCam [0].transform.position = new Vector3 (PlayerPosition.transform.position.x, PlayerPosition.transform.position.y + 4, PlayerPosition.transform.position.z);
		} 
		if(mode == 1){
			MyCam [1].transform.position = new Vector3 (PlayerPosition.transform.position.x, PlayerPosition.transform.position.y, PlayerPosition.transform.position.z + 20);
		}
		if(mode == 2){
